...
library polymer_ui_elements.polymer_ui_tabs;
...
@CustomTag('polymer-ui-tabs')
class PolymerUiTabs extends PolymerSelector {
  PolymerUiTabs.created() : super.created() {
    _logger.finest('created');
  }

  final _logger = new Logger('polymer-ui-tabs');
}
